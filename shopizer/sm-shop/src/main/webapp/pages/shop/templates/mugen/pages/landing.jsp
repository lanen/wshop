            ...
            <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner">
                    <div class="item animated fadeInUp active">
                        <img alt="First slide" src="<c:url value="/resources/templates/bootstrap3/img/slide_1.jpg"/>">
                        <div class="caption">
                    ...
                    <div class="item  animated fadeInUp">
                        <img alt="Second slide" src="<c:url value="/resources/templates/bootstrap3/img/slide_2.jpg"/>">
                        <div class="caption">
                            <div class=" slider-title animated fadeInDown delay1">GET YOUR DECORATION</div>
						...
						<c:if test="${requestScope.FEATURED_ITEM!=null}" >
							<div class="tab-pane fade <c:if test="${requestScope.FEATURED_ITEM!=null}" >active</c:if> in" id="tab1">
											...
											<c:set var="FEATURED" value="true" scope="request" />
		                         			<jsp:include page="/pages/shop/templates/mugen/sections/productBox.jsp" />
							</div>
						</c:if>
