...
<%@ page session="false" %>				
								...
								<c:url var="addShipping" value="/admin/shipping/addCountryToRegion.html"/> 
								 ...
								 <c:set value="/admin/shipping/weightBased/page.json" var="pagingUrl" scope="request"/>
								 <c:set value="/admin/shipping/weightBased/removeCountry.json" var="removeUrl" scope="request"/>
