           ...
           <div class="sm-ui-component">
			...
			<form:form method="POST" enctype="multipart/form-data" commandName="productKeyword" action="${addKeyword}">
				...
				<div class="form-actions">
				 ...
				 <c:set value="/admin/products/product/keywords/paging.json?id=${product.id}" var="pagingUrl" scope="request"/>
				 <c:set value="/admin/products/product/removeKeyword.json?id=${product.id}" var="removeUrl" scope="request"/>
