 ...
 * @author Carl Samson
 * @author Umesh
 * see The javascript re-creates the shopping cart div item (div id shoppingcart) (see webapp\pages\shop\templates\bootstrap\sections\header.jsp)
...
public class ShoppingCartController extends AbstractController {
     ...
     * 将 /addShoppingCartItem.html 修改成 item
     * @param item
     * @param request
     * @param response
     * @param locale
