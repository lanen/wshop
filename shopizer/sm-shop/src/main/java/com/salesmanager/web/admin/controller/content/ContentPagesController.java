...
public class ContentPagesController {
    ...
    @PreAuthorize("hasRole('CONTENT')")
    @RequestMapping(value = "/admin/content/remove.json", method = RequestMethod.POST, produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
    public
    @ResponseBody
    ...
    @PreAuthorize("hasRole('CONTENT')")
    @RequestMapping(value = "/admin/content/page.json", method = RequestMethod.POST, produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
    public
    @ResponseBody
     ...
     */
    @PreAuthorize("hasRole('CONTENT')")
    @RequestMapping(value = "/admin/content/checkContentCode.json", method = RequestMethod.POST, produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
    public
    @ResponseBody
